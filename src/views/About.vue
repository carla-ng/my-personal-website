        ...
        const content = [
            {
                text: `
                        ...
                        <br>
                        <p>También me gusta el <strong>diseño de videojuegos</strong> y he estudiado un poco sobre el tema (<strong>Photoshop</strong>, <strong>Maya</strong> y <strong>Unity</strong>).</p>
                      `,
