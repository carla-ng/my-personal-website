                                        ...
                                        <div class="window__text-description">
                                            <ul>
                                                <li v-for="(course,index) in online_courses_history" :key="index">
                                                    ...
                                                    <a v-if="course.certificate" :href="course.certificate" target="_blank">
                                                        [Certificado]
                                                    </a>
                                                </li>
                                            </ul>
